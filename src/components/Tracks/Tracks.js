  ...
  return (
    <div className="TracksHome" id="Tracks">
      ...
      <div className="TracksContainer">
        {/* <div
          className="TracksMoveButtons"
          // style={{ display: window.innerWidth > 740 ? "none" : "block" }}
        > */}

        <ArrowBackIosIcon
          className="TracksMoveUp"
          onClick={handleTracksUp}
          style={{ color: "white" }}
        />
        {/* </div> */}
        ...
        <ArrowForwardIosIcon
          className="TracksMoveDown"
          onClick={handleTracksDown}
          style={{ color: "white" }}
        />
        <motion.div
