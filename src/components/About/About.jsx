...
import "./About.css";
import team from "./AboutAssets/team.svg";
import left_pic from "./AboutAssets/left_pic.png";
import right_pic1 from "./AboutAssets/right_pic1.png";
import right_pic2 from "./AboutAssets/right_pic2.png";
...
function About() {
  ...
  const starsBottom = [
    123, 4, 425, 542, 243, -74, 845, 365, 652, 355, -9, 437, 3, 64, 854, 904,
    957, -36, 723, 643, 323, 6, 234, -58, 376, 485, 864, 901, 300, 954,
  ];
  const starsBottom2 = [
    133, -14, 525, 742, 43, -94, 5, 35, 62, 305, 293, 777, -13, 504, 154, 104,
    -8, 939, 3, 222, 323, 215, 834, 158, 916, -95, 1, 101, 500, 794,
  ];
      ...
      <div className="planet-container">
        <div className="content">
          <div className="team-image">
            <img src={team} className="amongus-team-image" alt="amongus-team" />
          </div>
      ...
      <div className="rightpic-container">
        <div className="right-pics-container">
          <div className="right-pics-inline-container">
            <img src={right_pic1} alt="right1" className="amongus-pic" />
            <img src={right_pic2} alt="right2" className="amongus-pic" />
          </div>
        </div>
        <div className="stars-container1">
          {stars.map((star, index) => (
