...
import amongus1 from "./AboutAssets/Among_us__1_-removebg-preview (3) 1.png"
import amongus2 from "./AboutAssets/Амонг_ас-removebg-preview 1 (1).png"
...
function About() {
  ...
  return (
    <div id="about" className="home-about">
      <img src={amongus2} className="amongus2"/>
      <img src={amongus1} className="amongus1"/>
      <div className="crew">
